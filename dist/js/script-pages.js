...
$(document).ready(function () {
  var path = $(location).attr("href").split("contato/", 1).reverse().join("");
  var file = "wp-content/themes/pisosabc/source/Support/Sender.php";
...
(function (global, factory) {
  ...
  var setParameters = function setParameters(params) {
    ...
    var closeButton = getCloseButton(); // Title
    ...
    cancelButton.setAttribute('aria-label', params.cancelButtonAriaLabel); // Set buttons to selected background colors
  ...
  var sweetAlert$1 = function sweetAlert() {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var buttonsWrapper = getButtonsWrapper();
      var confirmButton = getConfirmButton();
      var cancelButton = getCancelButton(); // Reverse buttons (Confirm on the right side)
      ...
      var setFocus = function setFocus(index, increment) {
        var focusableElements = getFocusableElements(params.focusCancel); // search for visible elements and select the next possible match
      ...
      for (var _i7 = 0; _i7 < inputTypes.length; _i7++) {
        ...
        input = getInput(inputTypes[_i7]); // set attributes
  ...
  sweetAlert$1.setDefaults = function (userParams) {
    ...
    showWarningsForParams(userParams); // assign valid params from userParams to popupParams
  ...
  sweetAlert$1["default"] = sweetAlert$1; // Remember state in cases where opening and handling a modal will fiddle with it.

  var states = {
    previousActiveElement: null,
    previousBodyPadding: null // Detect Node env
  ...
  var init = function init(params) {
    ...
    var textarea = getChildByClass(popup, swalClasses.textarea); // a11y
  ...
  /**
   * Inject a string of CSS into the product header
   *
   * @param {String} css
   */
  ...
  var injectCSS = function injectCSS() {
    var css = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ''; // Prevent run in Node env
...
/******/ 	__webpack_require__("./assets/js/vendors/jquery.js");
/******/ 	__webpack_require__("./assets/js/theme/functions/menu.js");
/******/ 	__webpack_require__("./assets/js/theme/functions/sticky.js");
/******/ 	__webpack_require__("./assets/js/vendors/sweetalert2.all.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./assets/js/theme/functions/request.js");
/******/ 	
/******/ })()
;