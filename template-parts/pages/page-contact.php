                   ...
                   <div class="contact__row__information__wrapper grid">
                             ...
                             <div class="contact__row__information__wrapper__card__content">
                                 ...
                                 <!-- body -->
                                  <div class="contact__row__information__wrapper__card__content__body">
                                      <address>
                                          <a rel="noreferrer noopener nofollow" href="<?= CONTACT['addressLink']; ?>" class="link-neutral-500" title="Venha conhecer a <?= SITE['name']; ?>" target="_blank"><?= CONTACT['address']; ?></a>
                                      </address>
                                  </div> 
                                 <!-- end of body -->
                             </div> 
                            ...
                            <!-- content -->
                             <div class="contact__row__information__wrapper__card__content">
                                 ...
                                 <!-- body -->
                                  <div class="contact__row__information__wrapper__card__content__body">
                                      <address>
                                          <a rel="noreferrer noopener nofollow" href="mailto<?= CONTACT['mail']; ?>" class="link-neutral-500" title="Envie um e-mail para a <?= SITE['name']; ?>" target="_blank"><?= CONTACT['mail']; ?></a>
                                      </address>
                                  </div> 
                                 <!-- end of body -->
                             </div> 
                             ...
                             <div class="contact__row__information__wrapper__card__content">
                                 ...
                                 <!-- body -->
                                  <div class="contact__row__information__wrapper__card__content__body">
                                      <ul>
                                          <li>
                                              <a rel="noreferrer noopener nofollow" href="tel:<?= formatPhone(CONTACT['phone']['01']); ?>" class="link-neutral-500" title="Solicite seu orçamento pelo telefone" target="_blank"><?= CONTACT['phone']['01']; ?></a>
                                          </li>
                                          <li>
                                              <a rel="noreferrer noopener nofollow" href="tel:<?= formatPhone(CONTACT['phone']['02']); ?>" class="link-neutral-500" title="Solicite seu orçamento pelo telefone" target="_blank"><?= CONTACT['phone']['02']; ?></a>
                                          </li>
                                      </ul>
                                  </div> 
                                 <!-- end of body -->
                       ...
                       <article class="contact__row__information__wrapper__card">
                           ...
                           <div class="contact__row__information__wrapper__card__content">
                               ...
                               <!-- body -->
                               <div class="contact__row__information__wrapper__card__content__body">
                                   <?= whatsapp(formatPhone(CONTACT["whatsapp"]["number"]["store"]), CONTACT["whatsapp"]["message"]["generic"], CONTACT["whatsapp"]["number"]["store"], 'link-neutral-500');  ?>
                               </div>
                               <!-- end of body -->
                           </div>
                           <!-- end of content -->
                   ...
                   <div class="contact__row__form__wrapper">
                       ...
                       <!-- header -->
                        <header class="contact__row__form__wrapper__header">
                            ...
                            <p class="t-justify">Envie-nos um e-mail com seu pedido de orçamento, dúvidas e sugestões que responderemos prontamente. Estamos à sua disposição por telefone e para um café em nossa loja.</p>
                        </header> 
                       <!-- end of header -->
                        ...
                        <div class="contact__row__form__wrapper__content mt-4">
                            <form id="form" method="POST" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="contact__row__form__wrapper__content__group">
                                    ...
                                    <textarea name="message" id="message" cols="30" rows="4" placeholder="Escreva a sua mensagem"></textarea>
                                </div>
                                <!-- end of group -->
