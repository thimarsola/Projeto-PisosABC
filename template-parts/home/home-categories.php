    ...
    <div class="container">
        ...
        <div class="categories__row grid">
            ...
            <header class="categories__row__header">
                ...
                <p class="t-justify mb-4">Invista em produtos de qualidade e originais de fábrica, aqui você pode
                    confiar!</p>
                <?= whatsapp(
                    formatPhone( CONTACT["whatsapp"]["number"]["store"] ),
                    CONTACT["whatsapp"]["message"]["generic"],
                    'Conheça mais',
                    'btn btn-primary-500',
                    'Conheça mais sobre a ' . SITE['name']
                ); ?>
            </header>
            <!-- end of header -->
            ...
            foreach ( $categoriesList['categories'] as $category ):
                ...
                <article class="categories__row__card">
                    <a href="<?= get_the_permalink( get_page_by_path( sanitize_title( $category['title'] ) ) ); ?>"
                       title="Conheça essa nossa linha de produtos">
                        <?= picture(
                            $category['image'],
                            'Conheça essa nossa linha de produtos',
                            'img-fluid'
                        ); ?>
